...
def bandpass_filter(data, lowcut, highcut, fs, order=4):
    ...
    print("Numerator coefficients (b):", len(b))
    print("Denominator coefficients (a):", len(a))
...
for i in range(1, len(ecg_csv)):
    ...
    authenticate_claimed_identity(XTI, Xq[i], threshold_array[i],names[i])
